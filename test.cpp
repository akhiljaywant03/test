...
int main ()
{
    ...
    // There are 20 coins. 5 heads and 15 trails. You can't see or feel them. And you should make them two groups such that no of heads are equal in both groups
    // Printing matrix A //
    cout << "Matrix A : \n ";
    for (i = 0; i < m; i++)
    {
